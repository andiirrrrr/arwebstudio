    ...
    public function run(): void
    {
        ...
        if (ServiceHero::count() === 0) {
            ServiceHero::create([
                ...
                'tech_stack_fast' => 'Laravel & Next.js',
                'tech_stack_secure' => 'SSL & Auth',
            ...
            $this->command->info('✅ Service Hero berhasil dibuat!');
        } else {
            $this->command->info('⚠️ Service Hero sudah ada, dilewati.');
        }
