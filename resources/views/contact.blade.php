            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="flex flex-col gap-8">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="contact-info-item group flex items-start gap-4 p-4 rounded-xl border border-transparent hover:border-[rgba(74,127,199,0.2)] hover:bg-[#1d2022] transition-all duration-300">
                            ...
                            <div class="pt-1">
                                ...
                                <p class="text-[15px] text-[#e0e3e5] leading-relaxed">Makassar, Sulawesi Selatan<br>Indonesia</p>
                            </div>
                        </div>
                    ...
                    <div class="contact-wa-btn">
                        <a href="https://wa.me/6285922107678" target="_blank" class="glow-pulse-green inline-flex items-center gap-3 bg-[#25D366] text-[#fff] px-8 py-4 rounded-full font-semibold text-sm hover:bg-[#128C7E] hover:scale-105 transition-all shadow-lg shadow-[#25D366]/20">
